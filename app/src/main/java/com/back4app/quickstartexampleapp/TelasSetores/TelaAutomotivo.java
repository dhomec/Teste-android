...
public class TelaAutomotivo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tela_automotivo);
    ...
    private void telaConfiguracao() {
        Intent intent = new Intent(TelaAutomotivo.this, TelaConfiguracao.class);
        startActivity(intent);

    } private void telaSugestoes() {
        Intent intent = new Intent(TelaAutomotivo.this, TelaSugestoes.class);
        startActivity(intent);

    } private void telaSair() {
        Intent intent = new Intent(TelaAutomotivo.this, TelaLogin.class);
        startActivity(intent);
    }
