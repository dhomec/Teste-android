...
public class TelaEletronicos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tela_eletronicos);
    ...
    private void telaConfiguracao() {
        Intent intent = new Intent(TelaEletronicos.this, TelaConfiguracao.class);
        startActivity(intent);

    } private void telaSugestoes() {
        Intent intent = new Intent(TelaEletronicos.this, TelaSugestoes.class);
        startActivity(intent);

    } private void telaSair() {
        Intent intent = new Intent(TelaEletronicos.this, TelaLogin.class);
        startActivity(intent);
    }
