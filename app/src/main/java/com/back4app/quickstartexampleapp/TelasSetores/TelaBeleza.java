...
public class TelaBeleza extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tela_beleza);
    ...
    private void telaConfiguracao() {
        Intent intent = new Intent(TelaBeleza.this, TelaConfiguracao.class);
        startActivity(intent);

    } private void telaSugestoes() {
        Intent intent = new Intent(TelaBeleza.this, TelaSugestoes.class);
        startActivity(intent);

    } private void telaSair() {
        Intent intent = new Intent(TelaBeleza.this, TelaLogin.class);
        startActivity(intent);
    }
