...
public class TelaFarmacias extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tela_farmacias);
    ...
    private void telaConfiguracao() {
        Intent intent = new Intent(TelaFarmacias.this, TelaConfiguracao.class);
        startActivity(intent);

    } private void telaSugestoes() {
        Intent intent = new Intent(TelaFarmacias.this, TelaSugestoes.class);
        startActivity(intent);

    } private void telaSair() {
        Intent intent = new Intent(TelaFarmacias.this, TelaLogin.class);
        startActivity(intent);
    }
