...
public class TelaDomestico extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tela_domestico);
    ...
    private void telaConfiguracao() {
        Intent intent = new Intent(TelaDomestico.this, TelaConfiguracao.class);
        startActivity(intent);

    } private void telaSugestoes() {
        Intent intent = new Intent(TelaDomestico.this, TelaSugestoes.class);
        startActivity(intent);

    } private void telaSair() {
        Intent intent = new Intent(TelaDomestico.this, TelaLogin.class);
        startActivity(intent);
    }
