...
public class TelaAlimentacao extends AppCompatActivity{
    ...
    private void telaConfiguracao() {
        Intent intent = new Intent(TelaAlimentacao.this, TelaConfiguracao.class);
        startActivity(intent);

    } private void telaSugestoes() {
        Intent intent = new Intent(TelaAlimentacao.this, TelaSugestoes.class);
        startActivity(intent);

    } private void telaSair() {
        Intent intent = new Intent(TelaAlimentacao.this, TelaLogin.class);
        startActivity(intent);
    }
